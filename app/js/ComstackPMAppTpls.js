angular.module('ComstackPMApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('html/deleteConversation.html',
    ...
    "\n" +
    "  <button ng-click=\"confirm()\" type=\"button\" class=\"btn btn-primary\" data-ng-disabled=\"OkClicked\">OK</button>\r" +
    "\n" +
    "</div>\r" +
    "\n"
  );
  ...
  $templateCache.put('html/inbox.html',
    ...
    "\r" +
    "\n" +
    "    <div class=\"alert alert-block alert-success\" ng-show=\"reportedConversation\">\r" +
    "\n" +
    "      <p class=\"close\" data-dismiss=\"alert\">×</p>\r" +
    "\n" +
    "      <p ng-bind=\"reportedConversation\"></p>\r" +
    "\n" +
    "    </div>\r" +
    "\n" +
    "\r" +
    ...
    "\n" +
    "              <a ui-sref=\"inbox.report({id: conversation.id})\" href=\"\" class=\"report-conversation\" ng-show=\"currentUser.permissions.conversations.report\"\r" +
    "\n" +
  ...
  $templateCache.put('html/message.html',
    ...
    "\r" +
    "\n" +
    "    <div class=\"pull-right cs-pm-right\"><a ng-click=\"cancel()\" class=\"btn btn-default messages-trigger\" ng-cloak><span\r" +
    "\n" +
