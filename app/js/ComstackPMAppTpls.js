angular.module('ComstackPMApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('html/conversation.html',
    ...
    "\n" +
    "    <h2 class=\"pull-left cs-pm-left\"><a ui-sref=\"inbox({page: 1})\" ui-sref-opts=\"{reload: true}\" class=\"messages-trigger\"><span class=\"icomoon icomoon-back cs-pm-icon--back\"></span>{{ heading__messages }}</a></h2>\r" +
    "\n" +
    "    <div class=\"pull-right cs-pm-right\"><a ui-sref=\"message\" class=\"btn btn-default cs-pm__new-message\"><span class=\"icomoon icomoon-speech-bubble cs-pm-icon--new-message\"></span> {{ button__new_conversation }}</a></div>\r" +
    "\n" +
    "  </div>\r" +
    "\n" +
    "\r" +
    ...
    "\n" +
    "      <a ng-hide=\"isContactBlocked\" href=\"\" ui-sref=\"conversation.block\" class=\"btn btn-link btn-small\"\r" +
    "\n" +
    "         ng-bind=\"link__block\"></a>\r" +
    "\n" +
    "      <a ng-show=\"isContactBlocked\" ui-sref=\"conversation.unblock\" class=\"btn btn-link btn-small\" ng-bind=\"link__unblock\"></a>\r" +
    "\n" +
    "    </div>\r" +
    "\n" +
    "  </div>\r" +
    ...
    "\r" +
    "\n" +
    "  <div id=\"conversation-wrapper\" class=\"conversation-wrapper\" style=\"max-height: 600px; overflow: auto\" scroll-glue=\"!!glued\" ng-show=\"isMobile\">\r" +
    "\n" +
    "\r" +
    "\n" +
    ...
    "\n" +
    "      <a class=\"btn btn-primary btn-load-more\" id=\"load-more\" ng-cloak ng-click=\"loadMessages('', paging.cursors.after)\" ng-show=\"isMobile && moreMessages\">{{\r" +
    "\n" +
    ...
    "\r" +
    "\n" +
    "    <ul class=\"media-list\" ng-show=\"isMobile\">\r" +
    "\n" +
    "      <li ng-repeat=\"message in messages\" buffer-size=\"10\" padding=\"0.3\" adapter=\"scrollAdapter\"\r" +
    "\n" +
    ...
    "\n" +
    "          <img class=\"media-object\" ng-src=\"{{ message.sender.avatars['100-100'] }}\" alt=\"\" style=\"width:50px;height:50px;\">\r" +
    "\n" +
    "        </div>\r" +
    "\n" +
    ...
    "\n" +
    "                                                     ng-bind=\"message.sent | dateFromNow\"></abbr></div>\r" +
    "\n" +
    "          <div class=\"cs-pm-message message\" ng-class=\"{'arrow_box': message.sender.id != $parent.currentUser.user.id}\"><p ng-bind-html=\"message.text | htmlsafe\"></p></div>\r" +
    "\n" +
    "        </div>\r" +
    "\n" +
    "      </li>\r" +
    ...
    "\r" +
    "\n" +
    "  <div id=\"conversation-wrapper\" class=\"conversation-wrapper\" style=\"max-height: 600px; overflow: auto\" ui-scroll-viewport scroll-glue=\"!!glued\" ng-hide=\"isMobile\">\r" +
    "\n" +
    "\r" +
    "\n" +
    "    <div class=\"delete-message-msg collapse\">\r" +
    ...
    "\n" +
    "      <li ui-scroll=\"message in messagesDatasource\" buffer-size=\"10\" padding=\"0.3\" adapter=\"scrollAdapter\"\r" +
    "\n" +
    "          ng-class=\"{'message-own': message.sender.id === $parent.currentUser.user.id}\"\r" +
    "\n" +
    "          class=\"media\">\r" +
    ...
    "\n" +
    "      <div class=\"form-group\" ng-class=\"{'has-error': newMessageForm.replyText.$invalid && newMessageForm.replyText.$dirty && (newMessageForm.replyText.$error.maxlength || newMessageForm.replyText.$error.required || (newMessageForm.replyText.$error.emoji && !allow_emoji))}\">\r" +
    "\n" +
    "\r" +
    "\n" +
    "         <textarea emoji\r" +
